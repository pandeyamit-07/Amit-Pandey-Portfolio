import './Home.css'
import amitImage from '../../assets/img/b.png';
        ...
        <div className="home-content">
          <div className="greeting-text">
            ...
            <div className="home-action-buttons">
              <a 
                href="https://github.com/pandeyamit-07" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="home-social-btn github-btn"
                aria-label="GitHub"
              >
              ...
              <a 
                href="https://www.linkedin.com/in/07-amitpandey/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="home-social-btn linkedin-btn"
                aria-label="LinkedIn"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a 
                href={resumePDF} 
                download="Amit_Pandey_Resume.pdf" 
                className="home-social-btn resume-btn"
